...
class Post extends dbObject{
    ...
    public static function getRecentPosts5(){
		return static::findByQuery("SELECT * FROM " . static::$db_table ." ORDER BY id DESC Limit 5 ");
	}
    
    public static function getRecentPosts7(){
		return static::findByQuery("SELECT * FROM " . static::$db_table ." ORDER BY id DESC Limit 7 ");
	}
    
    public static function catPosts4($cat_id){
		return static::findByQuery("SELECT * FROM " . static::$db_table ." WHERE cat_id = '$cat_id' ORDER BY id DESC Limit 4 ");
	}
